...
public class UpcomingVideoConsultationsAdapter extends BaseAllVideoConsultationsAdapter{
    ...
    public UpcomingVideoConsultationsAdapter(Context context, AdapterViewItemClickedListener adapterViewItemClickedListener, List<Appointment> appointmentList) {
